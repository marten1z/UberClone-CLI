...
public class TMUberDelivery extends TMUberService {
  ...
  public boolean equals(Object other) {
    ...
    if (!this.getServiceType().equals("DELIVERY") || !delivery.getServiceType().equals("DELIVERY")) {
      return false;
    }
    // If this and other are deliveries, check to see if they are equal
    if (this.restaurant.equals(delivery.getRestaurant()) && this.foodOrderId.equals(delivery.getFoodOrderId())) {
      return true;
    }
    return false;
  }
